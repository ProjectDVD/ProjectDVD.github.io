...
# About Us
The Project DVD curriculum is the culmination of a multi-year IMLS grant project to support school librarians in their implementation of evidence-based practices (EBP). We are grateful for the many people who helped this curriculum come to life.
...
##### Jennifer Moore, Ph.D.
<hr style="border: none; border-top: 3px dotted 329ea8;">
<img align="left" src="/img/Moore_profile_pic_ProjectDVD.png" alt="Moore headshot" width="25%" style="margin-right: 10px; margin-top: 10px;"/>
...
<img align="left" src="/img/Kodama_headshot_ProjectDVD.jpg" alt="Kodama headshot" width="25%" style="margin-right: 10px; margin-top: 10px;"/>
...
##### Nicole Wojcik
<hr style="border: none; border-top: 3px dotted gray;">
<img align="left" src="/img/Wojcik_headshot_ProjectDVD.jpeg" alt="Wojcik headshot" width="25%" style="margin-right: 10px; margin-top: 10px;"/>
...
##### Heidi Fendrick
<img align="left" src="/img/Fendrick_headshot_ProjectDVD.jpg" alt="Fendrick headshot" width="20%" style="margin-right: 10px;"/>
...
##### Sorrel Goodwin
<img align="left" src="/img/Goodwin_headshot_ProjectDVD.png" alt="Goodwin headshot" width="20%" style="margin-right: 10px;"/>
...
##### Lindsey Kimery
<img align="left" src="/img/Kimery_headshot_ProjectDVD.png" alt="Kimery headshot" width="20%" style="margin-right: 10px;"/>
...
##### Steven Lockard, PhD
<img align="left" src="/img/Lockard_headshot_ProjectDVD.jpg" alt="Lockard headshot" width="20%" style="margin-right: 10px;"/>
...
<img align="left" src="/img/Oakleaf_headshot_ProjectDVD_3-605x1024.jpg" alt="Oakleaf headshot" width="20%" style="margin-right: 10px;"/>
