...
| Teacher  | Response |
| ------------- | ------------- |
| Teacher 1  | I’ve heard about collaboration and am interested in trying it. But, I’m just so busy with this new grammar initiative… where will I find the time? My plate is already so full with grading and meetings, so this sometimes feels like one more thing to add to an overly busy schedule. |
...
| ------------- | ------------- | ------------- | ------------- |
| Teacher 1  | I’ve heard about collaboration and am interested in trying it. But, I’m just so ***busy*** with this new grammar initiative… where will I find the ***time***? ***My plate is already so full*** with grading and meetings, so this sometimes ***feels like one more thing*** to add to ***an overly busy schedule***. | “My plate is already so full”<br> “Feels like one more thing” | Too busy<br> Lack of time<br> Too busy |
| Teacher 2  | This is my first year teaching. Every time I turn around, there is ***just one more thing*** someone is asking me to do - my head is spinning! Maybe we can return to this next year? | "Just one more thing" |
| Teacher 3  | I ***don’t understand how collaboration works***. Where do we even begin? | "Don't understand how collaboration works" |
...
| ------------- | ------------- | ------------- | ------------- | ------------- |
| Teacher 1  | I’ve heard about collaboration and am interested in trying it. But, I’m just so ***busy*** with this new grammar initiative… where will I find the ***time***? ***My plate is already so full*** with grading and meetings, so this sometimes ***feels like one more thing*** to add to ***an overly busy schedule***. | “My plate is already so full”<br> “Feels like one more thing” | Too busy<br> Lack of time<br> Too busy | Too busy<br> Lack of time<br> Overwhelmed |
| Teacher 2  | This is my first year teaching. Every time I turn around, there is ***just one more thing*** someone is asking me to do - my head is spinning! Maybe we can return to this next year? | "Just one more thing" | Unfamiliar with process<br> Overwhelmed<br> Too busy |
| Teacher 3  | I ***don’t understand how collaboration works***. Where do we even begin? | "Don't understand how collaboration works" | Umfamiliar with process |
| Teacher 4  | I’ve just been ***so busy…*** it seems like there is ***no time*** to do everything I want to do. | | Too busy<br> Lack of time | Too busy<br> Lack of time |
| Teacher 5  | I’m new to this campus. I used to collaborate with the librarian at my other school only because they approached me. I’m  ***uncertain about approaching people*** to ask anyone for help. | | Too shy | Too shy |
